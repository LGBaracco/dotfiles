-- dashboard-nvim (doom theme): setup, oxocarbon highlight overrides, header art
-- highlighting, and buffer-local motion blocking. Requires the colorscheme to be
-- applied first (plugins.ui).
