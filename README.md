...
| **DankMaterialShell/** | [DankMaterialShell](https://github.com/AvengeMedia/DankMaterialShell) shell config used with niri.                                                                                              |
...
| **fish/**              | Semi-deprecated. These configs do not work on NixOS (NixOS has its own home-manager fish module).                                                                                               |
