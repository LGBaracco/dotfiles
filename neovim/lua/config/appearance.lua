-- Dashboard highlight overrides for the oxocarbon theme, ported from
-- appearance.nix (theme.extraConfig). Call `require("config.appearance").setup()`
-- once, after the colorscheme is applied (see plugins/ui.lua).
local M = {}
